...
class OrganisedData(RawData):
    ...
    def get_ac_interconnector_summary(self):
        ...
        # Create dicitionary containing collections of AC branches for which interconnectors are defined. Create. These collections are for both forward and reverse directions.
